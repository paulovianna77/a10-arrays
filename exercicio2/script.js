...
console.log('Foi adicionado um elemento 10, no primeiro array ? ' + numeros.includes(10))
console.log('Foi adicionado algum elemento "Pedro" no terceiro array? '+ todosJuntos.includes("Pedro"))